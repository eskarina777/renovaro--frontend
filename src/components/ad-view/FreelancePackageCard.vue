<template>
  <div class="sm:px-12 py-6">
    ...
    <div class="text-gray-600 ad-desc mb-8 mt-3" v-html="pkg?.packageDescription"></div>
    ...
    <div v-if="pkg?.packageInfo" class="bg-gray-100 text-gray-500 rounded-sm p-2 text-sm mt-4 mx-1">
...
import type { FreelancePackageType } from '@/types/Types'
import AdPrice from '../publish-ad-view/common/AdPrice.vue'

defineProps<{
  pkg: FreelancePackageType | null
  type: PackageType
