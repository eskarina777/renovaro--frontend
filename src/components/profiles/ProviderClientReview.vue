<template>
  <div>
    <div class="bg-white pt-[10px] px-6 rounded-sm border border-gray-200">
      ...
      <div v-else>
        <div class="flex items-end mt-2 border-t border-gray-200 py-2">
          <button
            class="ml-auto text-xs font-medium text-[#5ea480] border-[#5ea480] border px-3 py-1.5 rounded-md hover:border-gray-600 hover:text-gray-600"
          >
            Отговорете
          </button>
        </div>
